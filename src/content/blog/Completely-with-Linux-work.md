---
title: 完全用Linux工作 - 清华申请退学博士王垠作品
description: 《完全用Linux工作》是老文章了，这几天又被网上的人翻出来互相传阅，讨论。不过文中有作者自己独特的观点，windows用户与linux用户，GUIfans与CLIfans的口水战永不停歇。也许正如王垠所说，我们都被微软给算计了，但是国内大多人已经习惯了windows，这种“习惯”的东西是很难改变的。。。不过夜火我已经有所决定了，当我换机器的时候，我一定装Linux，发行版八成是Ubuntu了，并不是受这篇文章所“蛊惑”，而是早有意向及准备了，从我过去的一些文章已经可以看出来了。
date: 2009-02-05 10:38:37
category: 操作系统
tags: ['Linux']
post_id: 773
alias: Completely-with-Linux-work
ViewNums: 4796
---

**[《完全用Linux工作》](/blog/completely-with-linux-work)**是老文章了，这几天又被网上的人翻出来互相传阅，讨论。不过文中有作者自己独特的观点，[windows](/blog/deepin-litexp-windows-xp-sp3-v62)用户与[linux](/tags/Linux)用户，GUI fans与CLI fans的口水战永不停歇。也许正如王垠所说，我们都被微软给算计了，但是国内大多人已经习惯了[windows](/blog/deepin-ghost-xp-sp3-v90-iso)，这种“习惯”的东西是很难改变的。。。

不过[夜火](/blog/)我已经有所决定了，当我换机器的时候，我一定装Linux，发行版八成是[Ubuntu](/blog/ubuntu-8042-lts)了，并不是受这篇文章所“蛊惑”，而是早有意向及准备了，从我[过去的一些文章](/tags/Ubuntu)已经可以看出来了。

2005年9月22日，清华在读博士生王垠在水木社区BLOG上发表了《清华梦的粉碎--写给清华大学的退学申请》明确要求退学**,** 引起社会各界广泛争论. 他创作的长篇文章[《完全用Linux工作》](/blog/completely-with-linux-work), 洋洋两万多字, 从不同角度居高临下的阐述了他眼中Linux完全优越于[Windows](/blog/windows-7-beta)的各种理由**,** 这篇文章并不简单的是一篇论述"Windows能做的事Linux都能做"这样的文章, 通篇洋溢着一个彻底批判 [Windows](/blog/windows-server-2008-x86-dvd-chs) 平台基础的计算机哲学, 计算机应用和计算机教育体系的人的万丈豪情, 尽管可能偏激, 也不乏详细的推理论述。

我已经半年没有使用 [Windows](/blog/windows-server-2008-r2-beta) 的方式工作了。Linux 高效的完成了我所有的工作。

GNU/Linux 不是每个人都想用的。如果你只需要处理一般的事务，打游戏，那么你不需要了解下面这些了。

我不是一个狂热的自由软件份子，虽然我很喜欢自由软件。这篇文章也不是用来推行自由软件运动的，虽然我觉得自由软件运动是非常好的。

这篇文章也不是用来比较 Linux 和 [Windows](/blog/windows-server-2008-data-ent-sta-x64-chs) 内核效率，文件系统，网络服务的。我现在是作为一个用户而不是一个开发者来说话的，我们的讨论是基于操作，应用层面的。是为了告诉大学里还不了解，或者不理解 UNIX 的科学工作者和大学生，UNIX 比 Windows 更适合用于科学研究工作，请大家理解 UNIX 的工作方式，不要用 Windows 的标准来要求 Linux，而要用一个科学工作者的标准来要求自己，用UNIX 的思想来武装自己。
...
好了，现在全国的大学包括清华，几乎所有人机器必装盗版 Win2000，Office XP，学校的选课系统是非IE不能正确浏览，论文用 Word 编辑，演示用ppt做，email 的通知附件是 doc 文件，你不用 Word 打不开，连 863 项目都用 VC 写程序了。我很久以前就看到一份报纸说，"微软为什么不严厉打击盗版？" 这篇文章说，微软非但不打击中国的盗版行为，而且有放任之趋势。放长线吊大鱼，["以后我要你们加倍的来还我！"](http://www.cnbeta.com/articles/62988.htm) 确实如此，它的目的快实现了。
...
*Linux 的用户们都是关心解决世界的关键问题的份子，他们哪里有时间用自己的机器来玩游戏啊？他们每天用Linux高效的做完自己的工作就到阳光下享受自然去了。要玩游戏也是玩一些类似推箱子，贪吃蛇之类的智力小游戏。所以，你知道为什么 [Linux](/blog/completely-with-linux-work) 几乎没有游戏了吧？*
 **"整理硬盘，优化系统"**
...
有些人在抱怨为什么 Linux 没有一个良好的 IDE 开发环境。[Linux](/blog/completely-with-linux-work) 现在已经有一些IDE 了，但是总是有很多问题。你是不是正在寻找，正在期望 Linux 某一天可以有一个VC那样的开发环境？你有没有发现你正在进入微软给你设下的怪圈？你为什么一定要用 IDE？你说："IDE 开发迅速，调试方便，适合大型程序……" 那说明微软的程序在你脑子里已经比较根深蒂固，你需要好好清醒一下了，看看我来告诉你。
